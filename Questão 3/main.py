...
def read_rules():
    quant = int(
        input("digite a quantidade de regras da base de conhecimento:"))
...
def read_facts():
    quant = int(
        input("digite a quantidade de fatos da memória de trabalho:"))
...
def read_hypothesis():
    quant = int(
        input("digite a quantidade de hipoteses:"))
